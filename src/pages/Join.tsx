...
const CHANNELS = [
  { href: 'https://www.meetup.com/aws-sbg-at-government-college-of-engineering-kolhapur/', icon: Users,        label: 'Meetup Group',      sub: 'Join our events and meet the community.',             color: '#EC4899' },
  ...
  { href: 'https://www.instagram.com/aws.sbg.gcoe.kolhapur/', icon: Instagram, label: 'Instagram', sub: 'Event photos and behind-the-scenes.', color: '#A855F7' },
];
