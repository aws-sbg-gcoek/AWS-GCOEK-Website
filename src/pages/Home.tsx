          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <motion.div variants={stagger} initial="hidden" animate="visible" className="flex-1 min-w-0">
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                <a href="https://www.meetup.com/aws-sbg-at-government-college-of-engineering-kolhapur/" target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              { id: 'shardul-kolekar', name: 'Shardul Kolekar', role: 'Captain (President)', image: 'https://i.ibb.co/YBzRTFVx/Chat-GPT-Image-Sep-4-2026-12-34-54-PM.png', linkedin: 'https://www.linkedin.com/in/shardulkolekar', email: 'mailto:kolekarshardul23@gmail.com' },
