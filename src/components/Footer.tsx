          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              {[
                ...
                { href: 'https://www.meetup.com/aws-sbg-at-government-college-of-engineering-kolhapur/', icon: Users, color: '#EC4899' },
                { href: 'https://www.linkedin.com/company/aws-cloud-club-gcoe-kolhapur/', icon: Linkedin, color: '#38BDF8' },
                { href: 'https://www.instagram.com/aws.sbg.gcoe.kolhapur/', icon: Instagram, color: '#EC4899' },
