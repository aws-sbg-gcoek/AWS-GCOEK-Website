        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-3 group mb-6">
              ...
              <span className="font-heading font-bold text-2xl tracking-tight text-text-primary">
                AWS Student Builder Group <span className="text-arcade-purple">– GCOEK</span>
              </span>
            </Link>
            ...
            <div className="flex space-x-6">
              <motion.a whileHover={{ scale: 1.1, y: -2 }} href="https://github.com/AWSCloudClubGCOE" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-arcade-purple transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Events', 'Projects', 'Resources', 'Team', 'Join'].map((link) => (
                <li key={link}>
                  <Link to={link === 'Home' ? '/' : `/${link.toLowerCase()}`} className="text-text-secondary hover:text-arcade-purple transition-all duration-300 inline-block hover:translate-x-1">
                    {link}
                  </Link>
                </li>
              ))}
              <li>
                <a href="https://forms.gle/FHRKXqKDebaHRoaH8" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-arcade-purple transition-all duration-300 inline-block hover:translate-x-1">Submit feedback</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-text-secondary">
              ...
              <li className="pt-2">
                <a href="mailto:awssbggcoek@gmail.com" className="hover:text-arcade-purple transition-colors">
